...
interface NavbarProps {
  activeTab: 'tutor' | 'practice' | 'teacher' | 'scholarships' | 'oer' | 'classhub';
  setActiveTab: (tab: 'tutor' | 'practice' | 'teacher' | 'scholarships' | 'oer' | 'classhub') => void;
  selectedLanguage: LanguageCode;
  setSelectedLanguage: (lang: LanguageCode) => void;
  currentUser: AuthUser | null;
  currentStudent: StudentProfile | null;
  currentTeacher: TeacherProfile | null;
  currentClassInfo: ClassroomInfo | null;
    ...
    <header id="main-header" className="bg-white border-b border-[#E5E7EB] sticky top-0 z-40">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-8 py-1.5 border-b border-[#F0F2F5] flex flex-wrap items-center justify-between text-xs text-[#4B5563] gap-2">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <div className={`w-1.5 h-1.5 rounded-full ${isAiConnected ? 'bg-emerald-500' : 'bg-amber-500'}`}></div>
