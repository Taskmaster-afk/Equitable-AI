...
export const LoginPage = ({ onLoginSuccess }) => {
  ...
  const checkClassMatch = () => {
    ...
    const targetDigits = (verifiedClass.targetClass || "").match(/\b(12|11|10|9|8|7|6)\b/i)?.[1] || verifiedClass.classCode.match(/(12|11|10|9|8|7|6)/i)?.[1] || verifiedClass.className.match(/\bclass\s*(12|11|10|9|8|7|6)\b/i)?.[1] || "";
  ...
  return <div className="min-h-[85vh] flex items-center justify-center p-4 sm:p-6">
    ...
    className={`flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold transition-colors ${selectedRole === "student" ? "bg-black text-white" : "text-[#4B5563] hover:text-black hover:bg-[#F3F4F6]"}`}
  >
    ...
    className={`flex items-center gap-1.5 px-3 py-1.5 text-xs font-semibold transition-colors ${selectedRole === "teacher" ? "bg-black text-white" : "text-[#4B5563] hover:text-black hover:bg-[#F3F4F6]"}`}
  >
    ...
    /* Error Notification */
        ...
        {errorMessage && <div className="bg-rose-50 border-b border-rose-200 px-6 py-3 text-xs text-rose-700 flex items-start gap-2 font-medium">
    ...
    className={`pb-2.5 px-4 text-xs font-bold border-b-2 transition-all ${studentMode === "login" ? "border-black text-[#1A1A1A]" : "border-transparent text-[#6B7280] hover:text-black"}`}
  >
    ...
    className={`pb-2.5 px-4 text-xs font-bold border-b-2 transition-all flex items-center gap-1.5 ${studentMode === "register" ? "border-black text-[#1A1A1A]" : "border-transparent text-[#6B7280] hover:text-black"}`}
  >
    ...
    >
                      {existingStudents.map((s) => <option key={s.id} value={s.id}>
    ...
    >
      ...
      /* Class Code Lookup Error */
                    ...
                    {classCodeError && <div className="p-2.5 bg-rose-50 border border-rose-200 text-xs text-rose-700 flex items-center gap-1.5 font-medium">
      ...
      /* Live Class Matching Indicator */
                    ...
                    {verifiedClass && <div className="space-y-2">
                        {classMatchStatus?.matches ? <div
    ...
    >
                        ...
                        {regPassword && <div className="flex items-center gap-1 text-[10px] mt-0.5">
                            {regPassword.length >= 6 ? <span className="text-emerald-600 flex items-center gap-0.5">
                                <Check className="w-3 h-3" /> Minimum 6 characters met
                              </span> : <span className="text-amber-600 flex items-center gap-0.5">
    ...
    />
                        {regConfirmPassword && <div className="flex items-center gap-1 text-[10px] mt-0.5">
                            {regPassword === regConfirmPassword ? <span className="text-emerald-600 flex items-center gap-0.5">
                                <Check className="w-3 h-3" /> Passwords match
                              </span> : <span className="text-rose-600 flex items-center gap-0.5">
    ...
    >
                    <span>
                      {!verifiedClass ? "Please Verify Teacher Class Code First" : !classMatchStatus?.matches ? "Cannot Join: Class Mismatch with Code" : regPassword.length < 6 ? "Please Set a Password (min 6 chars)" : regPassword !== regConfirmPassword ? "Passwords Do Not Match" : `Complete Registration & Access ${regStudentClass} Dashboard`}
                    </span>
                    <ArrowRight className="w-3.5 h-3.5" />
                  </button>
                </form>
